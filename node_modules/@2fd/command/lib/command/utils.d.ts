export declare const TAB_SIZE: number;
export declare function commandSort(commandA: string, commandB: string): number;
export declare function toString(obj: any): string;
export interface Repeater {
    repeat(num: number): string;
}
export declare function repeat(str: string | Repeater, len: number): string;
